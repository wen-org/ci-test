...
python $cwd/demo_test/compare_out.py $cwd/demo_test/demo_v1.base $CONFIG_DIR/demo_v1.out
python $cwd/demo_test/compare_out.py $cwd/demo_test/demo_v2.base $CONFIG_DIR/demo_v2.out
