...
def check_issue_with_label(project, issue_type, label):
    """
    ...
    """
    issues = get_open_issues(project, issue_type, label)
    return issues
...
def prepare_issue_content(version_filepath, stable_tag_name):
    ...
    content += 'Commits since last stable:\n'
